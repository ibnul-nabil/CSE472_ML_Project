...
RESTORE_PATH   = f"{BASE_DIR}/Generation/best_model_sust.pth"
DATA_PATH      = f"{BASE_DIR}/Audio_Processing/"
META_TRAIN     = f"{BASE_DIR}/Audio_Processing/metadata_final_v3.csv"
OUTPUT_PATH    = f"{BASE_DIR}/Audio_Processing/tuned_model"
...
# Sanity check — verify dataset loads correctly
...
assert len(train_samples) > 0, "❌ No training samples found — check your metadata path and format"
